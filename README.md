...
| <a name="input_additional_origins"></a> [additional\_origins](#input\_additional\_origins) | One or more additional origins for this distribution (multiples allowed). | `any` | `{}` | no |
...
| <a name="input_extra_cloudfront_distributions"></a> [extra\_cloudfront\_distributions](#input\_extra\_cloudfront\_distributions) | Extra CloudFront distributions to be associated with the S3 bucket policy | `list(string)` | `[]` | no |
